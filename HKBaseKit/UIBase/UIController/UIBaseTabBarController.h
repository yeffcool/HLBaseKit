...
@interface UIBaseTabBarController : UIBaseViewController <UIBaseTabBarViewDelegate>
{
...
@optional
- (BOOL)tabBarController:(UIBaseTabBarController *)tabBarController shouldSelectViewController:(UIViewController *)viewController;
- (void)tabBarController:(UIBaseTabBarController *)tabBarController didSelectViewController:(UIViewController *)viewController;
@end

@interface UIViewController (CustomTabBarControllerSupport)
@property(nonatomic, retain, readonly) UIBaseTabBarController *customTabBarController;
@end
